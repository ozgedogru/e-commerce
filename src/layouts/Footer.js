const Footer = () => {
  return (
    <div className="flex flex-col justify-center w-full">
      <div className="flex flex-col justify-center w-full">
        <div className="bg-lightgrey flex justify-center sm:px-48 px-8">
          <div className="flex sm:justify-between justify-start items-center w-full py-10">
            <div className="flex flex-col items-start justify-center">
              <p className="text-black text-start text-2xl font-bold leading-8">
                BrandName
              </p>
        ...
        <div className="flex justify-center sm:px-48 px-8">
          <div className="flex flex-col sm:flex-row sm:flex-wrap justify-between items-start w-full gap-8 py-10 font-bold text-sm">
            ...
            <div className="flex flex-col items-start min-w-max sm:gap-4 gap-1 text-secondtext ">
              ...
              <label>
                <div className="inline-flex shadow-md w-72 rounded-s-lg">
                  <input className="py-3 px-4 block w-full border-lightgrey2 rounded-s-lg text-sm"></input>
                  <button className="flex px-4 py-3 justify-center items-center bg-primary hover:bg-shineblue text-white text-base font-bold leading-6 tracking-wider rounded-e-lg">
                    Subscribe
                  </button>
                </div>
              </label>
        ...
        <div className="bg-lightgrey flex justify-center items-center h-16 w-full sm:px-48 px-8">
