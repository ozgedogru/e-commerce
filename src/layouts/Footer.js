  ...
  return (
    <div className="flex justify-center w-full">
      <div className="flex flex-col justify-center w-full">
        <div className="bg-lightgrey flex justify-center px-24">
          <div className="flex flex-wrap justify-between items-center w-full py-10">
        ...
        <div className="flex justify-center px-24">
          <div className="flex flex-wrap justify-between items-start w-full gap-8 py-10 font-bold text-sm">
        ...
        <div className="bg-lightgrey flex justify-center items-center h-16 w-full px-24">
