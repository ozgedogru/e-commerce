...
const DeleteModal = ({ isOpen, onConfirmDelete, onCancelDelete }) => {
  return (
    <Modal
      isOpen={isOpen}
      onRequestClose={onCancelDelete}
      contentLabel="Delete Address Confirmation"
    ...
    >
      <div className="flex flex-col">
        <h2 className="text-center font-bold mb-2 text-lg">Delete Address</h2>
