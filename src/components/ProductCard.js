...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link to={`${url}`}>
      <div className="flex flex-col items-center justify-around sm:w-[16rem] sm:min-h-[36rem] w-72 gap-4 pb-8 shadow-md hover:scale-105 transition duration-300 cursor-pointer">
